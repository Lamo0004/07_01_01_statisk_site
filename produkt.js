...
function visProdukt(produkt) {
  ...
  document.querySelector(".grid_1-1 h2").textContent = produkt.productdisplayname;
  document.querySelector(".grid_1-1 .type").textContent = produkt.articletype;
  document.querySelector(".grid_1-1 .brand").textContent = produkt.brandname;
  document.querySelector(".grid_1-1 .pris").textContent = produkt.price;
